...
export const GAME_COMPONENTS = [
    ...
    // ─── COMBAT ────────────────────────────────────────────────────────────────
    {
        ...
        vibePrompt: 'I have the basic melee attack applied. Now make it feel AAA: add hit-stop (freeze 3 frames on ' +
    ...
    },
    {
        ...
        vibePrompt: 'I have a 3-hit combo applied to this entity. Extend it with: (1) a heavy finisher on the 3rd ' +
        ...
        buildGraph: (ent) => {
            ...
            nodes.push(init, reset, btn, step, sw, atk1, set1, hb1On, wait1, hb1Off, atk2, set2, hb2On, wait2, hb2Off, atk3, set3, hb3On, wait3, hb3Off, hitEvt, dmg, sfx, vfx, animEnd, rstEnd);
    ...
    },
    {
        ...
        vibePrompt: 'I have dodge roll applied. Now add: (1) directional dodge — detect stick X/Y and set the dodge ' +
        ...
        buildGraph: (ent) => {
            ...
            nodes.push(btn, stam, enoughStam, stamVal, gate, anim, vel, iOn, drainAmt, newStam, setStam, waitActive, iOff, decel, tick, curStam, maxChk, maxVal, recov, addStam, rateVal, saveSt);
    ...
    },
    {
        ...
        vibePrompt: 'I have lock-on targeting applied. Extend it: (1) while locked on, strafe with left stick ' +
        ...
        buildGraph: (ent) => {
            ...
            nodes.push(zBtn, locked, isLocked, zeroVal, branch, findNearest, setTarget, setLocked, clearLock, tick, chkLock, isOn, oneVal, guard, getTarget, camAim, faceEnemy, cUp, cycle, saveNext);
    ...
    },
    {
        ...
        vibePrompt: 'I have the health/damage system applied. Now add: (1) damage types — read a "DamageType" ' +
    ...
    },
    {
        ...
        vibePrompt: 'I have the ranged weapon applied. Add: (1) ammo limit — maximum 12 shots stored in state ' +
    ...
    // ─── UI ────────────────────────────────────────────────────────────────────
    {
        ...
        vibePrompt: 'I have the health bar applied. Now add: (1) a low-health warning — when HP ≤ 25% pulse ' +
    ...
    },
    {
        ...
        vibePrompt: 'I have the stamina bar HUD applied. Extend it: (1) delay recovery by 0.8s after the last ' +
        ...
        buildGraph: (ent) => {
            ...
            const ratio = node('Divide', 680, 50);
            const hudBar = node('SetHUDBar', 880, 50, { element: 'StaminaBar', colorLow: '#e8c040', colorHigh: '#40aaff' });
    ...
    },
    {
        ...
        vibePrompt: 'I have the boss health bar applied. Now add: (1) at each phase boundary (75%, 50%, 25% HP) ' +
        ...
        buildGraph: (ent) => {
            ...
            const hudBar = node('SetHUDBar', 880, 250, { element: 'BossHealthBar', colorLow: '#ff2020', colorHigh: '#20e840', segments: 4 });
            // On death: hide bar
    ...
    },
    {
        ...
        vibePrompt: 'I have floating damage numbers applied. Now: (1) color-code by damage type — physical: white, ' +
    ...
    },
    {
        ...
        vibePrompt: 'I have the dialogue box applied. Extend it: (1) add a "choice branch" — on specific pages ' +
        ...
        buildGraph: (ent) => {
            ...
            nodes.push(enter, intBtn, guard, showBox, setName, setFlag, setPage, type0, beep0, adv, inDlg, page, sw, type1, type1End, close, clrFlg, sig);
    ...
    },
    {
        ...
        vibePrompt: 'I have the score counter applied. Now add a combo multiplier: (1) each enemy defeat within ' +
